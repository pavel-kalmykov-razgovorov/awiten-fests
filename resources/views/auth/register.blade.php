                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="toggle-trigger" name="tipo-usuario" type="checkbox" checked data-toggle="toggle" data-on="{{ trans('translate.representante')}}" data-off="{{ trans('translate.promotor')}}" value="Manager">
                            </div>
                         </div>
