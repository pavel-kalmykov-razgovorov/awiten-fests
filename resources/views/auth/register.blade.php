                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <label for="password-confirm" class="col-md-4 control-label texto-comun">Confirmación
                                        de Contraseña</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="password-confirm" class="col-md-4 control-label texto-comun">Tipo de
                                        Usuario</label>
                                    <div class="col-md-6">
                                        <input id="toggle-trigger" name="tipo-usuario" type="checkbox" checked
                                               data-toggle="toggle" data-on="Manager" data-off="Promotor"
