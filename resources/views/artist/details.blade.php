        ...
        @if(isset($artist))
            <div>
                <div class="fondo-artista">
                    <div>
                        <div>
                            <img style='height: 100%; width: 100%;' class="profileHeaderBackground"
                                 src="{{ asset('images/artistas/' . trim($artist->permalink) . '/' . 'fondo.jpg') }}">
                            <h3 style="font-family:verdana; text-align:center">PRÓXIMAS ACTUACIONES </h3>
                            <img class="image-encima" src={{ asset('images/logos2/Soundcloud.png') }} alt="soundcloud"
                                 width="82" height="82" align="left">
                        </div>
                    </div>
                </div>
            </div>
            ...
            @forelse($artist->festivals()->get(['permalink', 'name', 'location', 'date']) as $festival)
                <div class="post-container1">
                    ...
                    <div class="post-content1">
                        <h4 class="post-title1"><a href="/festival/{{$festival->permalink}}">{{$festival->date}}</a>
                        </h4>
