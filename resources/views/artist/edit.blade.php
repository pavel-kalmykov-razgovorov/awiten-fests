...
<h1 style="color: black;">Editar Artista</h1>
@if(count($errors) > 0)
    <h3>Hay errores:</h3>
    <ul>
...
<form action="{{action('ArtistController@Update', $permalink)}}" method="post">
    ...
    <input style="color: black;" type="button" onclick="window.location = '{{action('ArtistController@Details', $permalink)}}';"
           value="Cancelar">
    <input style="color: black;" type="submit" value="Editar">
</form>
