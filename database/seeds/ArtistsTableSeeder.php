    ...
    public function run()
    {
        ...
        DB::table('artists')->insert(
            [
                ...
                ['name' => 'DJ Tremor', 'soundcloud' => 'https://soundcloud.com/djtremoor', 'website' => 'http://www.pordede.com/', 'country' => 'Spain', 'permalink' => 'dj-tremor', 'pathProfile' => 'profile.jpg', 'pathHeader' => 'fondo.jpg', 'manager_id' => $managers_ids[rand(0, count($managers_ids) - 1)]],
